...
-----------------------
	...
	Visual Studio Version: Visual Studio 2017 (v141)
	-The above are just versions of my Visual Studio and Windows SDK the version shouldnt be required to build just there for information-
	-This project was built only for Microsoft Visual Studio and only requires the folder called dsound included in the project to run-
